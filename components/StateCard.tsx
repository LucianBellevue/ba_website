...
export default function StateCard({ name, slug, shortBlurb }: StateCardProps) {
  return (
    <Link href={`/states/${slug}`} className="block bg-white rounded-lg border border-gray-200 p-6 hover:shadow-lg hover:border-[var(--ba-blue)] transition-all">
      <h3 className="font-serif text-xl font-bold text-[var(--ba-navy)] mb-2">{name}</h3>
