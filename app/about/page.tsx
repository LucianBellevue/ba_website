      ...
      <section className="py-16 md:py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose max-w-none">
            ...
            <h2 className="font-serif text-2xl md:text-3xl font-bold text-ba-navy mb-6">Connect With Us</h2>
            <p className="text-lg text-gray-700 mb-4">
              Follow us on social media to stay updated on life insurance tips, company news, and helpful resources.
            </p>
            <div className="flex items-center gap-4">
              <a
                ...
                className="inline-flex items-center gap-2 px-4 py-2 bg-ba-bg text-ba-navy rounded-lg hover:bg-ba-blue hover:text-white transition-colors"
              >
