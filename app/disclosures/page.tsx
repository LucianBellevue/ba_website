    ...
    <>
      ...
      <section className="py-16 md:py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="font-serif text-2xl font-bold text-[var(--ba-navy)] mb-4">About Bellevue Assurance</h2>
          ...
          <h2 className="font-serif text-2xl font-bold text-[var(--ba-navy)] mb-4">Product Availability</h2>
          ...
          <h2 className="font-serif text-2xl font-bold text-[var(--ba-navy)] mb-4">No Government Affiliation</h2>
          ...
          <h2 className="font-serif text-2xl font-bold text-[var(--ba-navy)] mb-4">Underwriting and Approval</h2>
          ...
          <h2 className="font-serif text-2xl font-bold text-[var(--ba-navy)] mb-4">Quotes and Pricing</h2>
          ...
          <h2 className="font-serif text-2xl font-bold text-[var(--ba-navy)] mb-4">Compensation Disclosure</h2>
          ...
          <h2 className="font-serif text-2xl font-bold text-[var(--ba-navy)] mb-4">Consumer Communication Consent</h2>
          ...
          <h2 className="font-serif text-2xl font-bold text-[var(--ba-navy)] mb-4">Licensing Information</h2>
