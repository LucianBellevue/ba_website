    ...
    <>
      ...
      <section className="py-16 md:py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 prose max-w-none">
          <h2 className="font-serif text-2xl md:text-3xl font-bold text-[var(--ba-navy)] mb-6">What is Final Expense Insurance?</h2>
          ...
          <h2 className="font-serif text-2xl md:text-3xl font-bold text-[var(--ba-navy)] mb-6">Who Is Final Expense Insurance For?</h2>
          ...
          <h2 className="font-serif text-2xl md:text-3xl font-bold text-[var(--ba-navy)] mb-6">How Does It Work?</h2>
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            {[{ step: "1", title: "Apply", desc: "Complete a simple application by phone with a licensed agent." }, { step: "2", title: "Get Approved", desc: "Many applications receive same-day approval." }, { step: "3", title: "Coverage Begins", desc: "Your policy is active and your family is protected." }].map((item, i) => (
              <div key={i} className="bg-[var(--ba-bg)] p-6 rounded-lg text-center">
                <div className="w-10 h-10 bg-[var(--ba-gold)] text-[var(--ba-navy)] rounded-full flex items-center justify-center font-bold text-lg mx-auto mb-3">{item.step}</div>
