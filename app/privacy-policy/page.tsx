    ...
    <>
      ...
      <section className="py-16 md:py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 prose max-w-none">
          <h2 className="font-serif text-2xl font-bold text-[var(--ba-navy)] mb-4">Introduction</h2>
          ...
          <h2 className="font-serif text-2xl font-bold text-[var(--ba-navy)] mb-4">Information We Collect</h2>
          ...
          <h2 className="font-serif text-2xl font-bold text-[var(--ba-navy)] mb-4">How We Use Your Information</h2>
          ...
          <h2 className="font-serif text-2xl font-bold text-[var(--ba-navy)] mb-4">Information Sharing</h2>
          ...
          <h2 className="font-serif text-2xl font-bold text-[var(--ba-navy)] mb-4">Your Rights</h2>
          ...
          <h2 className="font-serif text-2xl font-bold text-[var(--ba-navy)] mb-4">Contact Us</h2>
          <p className="text-gray-700">If you have questions about this Privacy Policy, please contact us at info@bellevueassurance.com or call (800) 555-0123.</p>
        </div>
      </section>
    </>
  );
