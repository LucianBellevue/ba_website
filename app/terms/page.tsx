    ...
    <>
      ...
      <section className="py-16 md:py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="font-serif text-2xl font-bold text-[var(--ba-navy)] mb-4">Agreement to Terms</h2>
          ...
          <h2 className="font-serif text-2xl font-bold text-[var(--ba-navy)] mb-4">Use of Website</h2>
          ...
          <h2 className="font-serif text-2xl font-bold text-[var(--ba-navy)] mb-4">Insurance Services</h2>
          ...
          <h2 className="font-serif text-2xl font-bold text-[var(--ba-navy)] mb-4">No Guarantee of Coverage</h2>
          ...
          <h2 className="font-serif text-2xl font-bold text-[var(--ba-navy)] mb-4">Intellectual Property</h2>
          ...
          <h2 className="font-serif text-2xl font-bold text-[var(--ba-navy)] mb-4">Limitation of Liability</h2>
          ...
          <h2 className="font-serif text-2xl font-bold text-[var(--ba-navy)] mb-4">Changes to Terms</h2>
          ...
          <h2 className="font-serif text-2xl font-bold text-[var(--ba-navy)] mb-4">Contact</h2>
